...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-njnqgf0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-njnqgf0.containers.anotherwebservice.com/
...
```
git clone git@github.com:sprinter11/container-njnqgf0.git
cd container-njnqgf0
```
...
```
docker attach container-njnqgf0
```
